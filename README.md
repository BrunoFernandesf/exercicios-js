# exercicios-js
##Seção 1: Exercícios Fáceis (Fundamentos de JS + DOM Básico)
###Soma de Números
...
Crie uma função que, ao ser chamada, altere o conteúdo de um parágrafo específico no DOM para "Texto alterado".

Alterar o Atributo href de um Link

Selecione um link (<a>) e altere seu atributo href para "https://www.novosite.com".

##Seção 2: Exercícios Intermediários (Estruturas de Controle + Manipulação de DOM)
Verificar se um Número é Primo

Crie uma função que verifique se um número é primo (número divisível apenas por 1 e ele mesmo).

Filtrar Itens de uma Lista no DOM

Crie uma lista de 5 itens e adicione um campo de input para filtrar os itens da lista conforme o usuário digitar.

Contagem Regressiva

Crie uma função que exiba uma contagem regressiva de 10 segundos no console.

Adicionar um Novo Item ao DOM

Crie um botão que, quando clicado, adicione um novo item à lista com um id único.
...
Crie uma lista de itens onde o usuário pode clicar para remover um item ou adicionar um novo item.
